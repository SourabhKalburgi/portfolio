    ...
    <section className={`paddings ${css.wrapper}`}>
      ...
      >
        ...
        <a className={css.email} href="mailto:zainkeepscode@gmail.com">
          sourabhkalburgi35@gmail.com
        </a>

        <div className={css.lowerElements}>
          <motion.div variants={fadeIn("right", "tween", 0.3, 1)} className={css.experience}>
            <div className="secondaryText">Certified</div>
          ...
          <motion.div variants={fadeIn("left", "tween", 0.5, 1)} className={css.certificate}>
            ...
            <a className="uxcertificate" href="https://sourabhkalburgi18.wixsite.com/portfolio" >CERTIFIED PROFESSIONAL</a>
